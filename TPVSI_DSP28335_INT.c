...
//	AAL_Trans_SetDQ0Value(&Control_Data,0.9,0,0);
	AAL_Trans_SetDQ0Value(&Target_Data,0.8,0,0);
...
#if DEBUG_DAC_OUTPUT
	HAL_PWM_DutyValue_Cal(&_p_epwm4,Target_Data.abc_data[index_a],0.9,-0.9);
	HAL_PWM_DutyValue_Cal(&_p_epwm5,Inverter_Current_Data.abc_data[index_a],0.9,-0.9);
